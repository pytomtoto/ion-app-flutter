...
function add_permission_label() {
    ...
    python3 add-line.py -i ../ios/Podfile -s "# platform :ios" -t "platform :ios" -r
    echo ""
    echo "Add permission labels to AndroidManifest.xml."
    echo ""
    python3 add-line.py -i ../android/app/build.gradle -s 'minSdkVersion 16' -t 'minSdkVersion 18' -r
